 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'In the moment when I truly understand my enemy, understand him well enough to defeat him, then in that very moment I also love him. I think it’s impossible to really understand somebody, what they want, what they believe, and not love them the way they love themselves. And then, in that very moment when I love them.... I destroy them.');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:nickaguilarh/Destiny-Networks.git');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/tmp/sgit-'.md5(REMOTE_REPOSITORY).'/');
 ...
 */
define('COMPOSER_HOME', '/home/nickaguilarh');
 ...
 */
define('EMAIL_ON_ERROR', 'nickaguilarh@gmail.com');
